...
namespace ProductService.Component.Tests
{
	...
	public class AnotherEndpointTests
	: IClassFixture<ProductServiceFactory<Program>>
	{
		...
		public AnotherEndpointTests(ProductServiceFactory<Program> factory)
		{
			_factory = factory;
		...
		[Fact]
		public async Task AnotherGet_ProductInfo_ReturnsProductInfo()
		{
			// arrange
